...
data_root = '/home/akore/mmdet_project/dataset_dot/'
...
val_evaluator = dict(
    ...
    classwise=True,
    format_only=False,
    outfile_prefix='./work_dirs/yolox_tt-dot_dataset-test/val'
)
...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        #draw=True,
        score_thr=0.001,
        test_out_dir= './work_dirs/yolox_tt-dot_dataset-test/results_test'
        ))
